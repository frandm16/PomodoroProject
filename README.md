...
- `BACKEND_PUBLIC_PORT`: port exposed on your machine by Docker Compose.
- `BACKEND_PRIVATE_PORT`: port where Spring Boot listens inside the process and container.
